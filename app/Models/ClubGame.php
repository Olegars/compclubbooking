...
class ClubGame extends Model
{
     ...
     *
     * - free: только shell (walk-in), в бронь ПК не попадает.
     * - paid: можно забронировать заранее; в shell по-прежнему доступна
     *   как обычная выдача аккаунта, если нет удерживающей резервации.
     */
