            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => "Депозит и бонусный баланс. Списание за бронь и магазин, пополнение с кассы или из кабинета/шелла через ЮKassa (карта / СБП).\n\nМодель 54‑ФЗ: пополнение кошелька — чек «аванс»; списание на бронь/магазин — «полный расчёт» с зачётом аванса (KkmServer). Пока FISCAL_ENABLED=false — в UI отдаётся демо-заглушка чека (/receipt/stub/{id}), без вызова ККТ.",
                        'path' => '/admin/transactions',
                    ...
                    [
                        ...
                        'description' => "После подтверждения оплаты — окно с QR по fiscal_receipt_url (ОФД или демо-заглушка).\n\n• ЛК сайта: Success после виджета ЮKassa + кнопка «Чек» / «Чек · демо» в логе транзакций.\n• Шелл / приложение: тот же URL в истории; Success QR на шелле — по тому же API.\n• Терминал: экран с QR 20–30 с или до «Завершить»; URL пишется в историю профиля.",
                        'path' => '/account/dashboard',
                        'audience' => 'Терминал / Сайт / App / Shell',
                    ],
                    [
