            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => "Редактирование никнейма, email и фото (ЛК /account/profile и карточка аватара в кабинете). Телефон зафиксирован как идентификатор входа. Стартовый ник при первой регистрации выдаёт DeepSeek (см. «Игровой ник»).\n\nСвоё фото: POST /account/profile/avatar. Галка «Стилизовать под клубный формат»: хостовый DeepSeek картинки не рисует (только текст). Если в админке есть OpenAI-ключ — images/edits. Иначе лицо с фото вставляется в овал стандартного avatar_*.png — броня, причёска и зелёные схемы шаблона остаются, фото целиком зелёной вуалью не красится.",
