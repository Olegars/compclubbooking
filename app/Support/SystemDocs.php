        ...
        return [
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Пересменка',
                        'description' => 'Закрытие смены: касса + факт остатков. Кто принял смену — активный админ с полным функционалом; кто сдал — неактивный и видит только личный кабинет. Стажёр в пересменке смену не принимает.',
                    ...
                    [
                        ...
                        'description' => 'Смены, начисления, штрафы, вывод. Календарь свободных слотов: «Выбрать смену» как на складе (слот, если есть место). Отмена не позднее чем за 48 часов до начала. Схема смен (12/24 часа и час начала) задаётся в конфигурации клуба. Новая регистрация: правила (каждое — «Принимаю»), ФИО, паспорт, скан, «Устроиться» — анкета уходит владельцу/управляющему. Пока проверка — «На проверке», кабинет закрыт. Отклонение показывает причину, можно исправить и отправить снова. После одобрения открывается кабинет. Неактивный админ и стажёр видят только эту страницу.',
                        'path' => '/admin/salary',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Штат',
                        'description' => 'Список сотрудников: должность (админ / стажёр), живой статус смены (активный / неактивный / стажёр), ставка, сумма к выводу. Вкладка «На проверке» — анкеты устройства: паспорт, скан, «Одобрить» или «Отклонить» с причиной. После одобрения стажёр получает личный кабинет. Владелец и управляющий назначают должность админ↔стажёр и могут выписать штраф. Владелец может удалить сотрудника (не себя, не единственного владельца и не админа на открытой смене).',
                        'path' => '/admin/staff',
                        'audience' => 'Supervisor+',
                    ],
                    [
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'description' => 'Схема рабочих смен клуба: 12 часов (день/ночь) или 24 часа, час начала (10:00, 11:00, 12:00…). Конец считается автоматически. Уже выбранные смены сотрудников сохраняются, свободные слоты другой схемы снимаются. Доступ: владелец и управляющий.',
                        'path' => '/admin/config',
                        'audience' => 'Supervisor+',
                    ],
                    [
