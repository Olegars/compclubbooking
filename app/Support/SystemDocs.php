...
• Образ: клиент + FACEIT.sys Running. Update AC только циклом Update → Reboot Super Client → служба Running → save.
• Login шелла: junction Local + Roaming на D:/ShellData/faceit/{user_id}/…; logout: wipe D: + reg delete HKCU\\Software\\FACEIT + снять junction.
