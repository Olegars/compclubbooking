        ...
        return [
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Смены, начисления, штрафы, вывод. Календарь свободных слотов: «Выбрать смену» как на складе (слот, если есть место). Отмена не позднее чем за 48 часов до начала. Схема смен (12/24 часа и час начала) задаётся в конфигурации клуба. Новая регистрация сотрудника сначала проходит устройство на работу в этом же кабинете: попап с правилами (каждое — «Принимаю»), ФИО, паспорт, скан, затем кнопка «Устроиться». Неактивный админ и стажёр видят только эту страницу. Неактивный принимает текущую смену отсюда; стажёр выходит вместе с активным админом.',
                        'path' => '/admin/salary',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Штат',
                        'description' => 'Список сотрудников: должность (админ / стажёр), живой статус смены (активный / неактивный / стажёр), ставка, сумма к выводу. Активный — тот, кто принял текущую смену. Владелец назначает должность админ↔стажёр и может выписать штраф.',
                        'path' => '/admin/staff',
                        'audience' => 'Owner',
                    ],
                    [
