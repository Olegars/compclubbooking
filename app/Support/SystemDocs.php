            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Смены, начисления, штрафы, вывод. Календарь свободных слотов: «Выбрать смену» как на складе (слот, если есть место). Отмена не позднее чем за 48 часов до начала. Неактивный админ и стажёр видят только эту страницу. Неактивный принимает текущую смену отсюда; стажёр выходит вместе с активным админом.',
                        'path' => '/admin/salary',
