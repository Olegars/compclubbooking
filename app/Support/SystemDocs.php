            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => "Не реализовано в booking: управление CCBoot/SENET/NDEV, смена образа, Steam-кэш как сервис.\n\nСеть под бездиск — в разделе «Сеть клуба»: VLAN 20 общий L2 сервер+ПК, 2×10G LACP на CRS354, DHCP только один источник. Админка оркестрирует лицензии/WOL, не PXE.",
                        'path' => '/admin/licenses',
