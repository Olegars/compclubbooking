            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Визуальная карта зала: spaces, размещение ПК / TV / PS5. Сохраняет map_config клуба и синхронизирует computers и spaces. Комната без привязанного ПК/ТВ на карте рисуется на 80% прозрачной с подписью SERVICE.',
