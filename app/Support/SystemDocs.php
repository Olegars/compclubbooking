        ...
        return [
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Моя зарплата',
                        'description' => 'Личный раздел сотрудника: отработанные смены (пришёл / ушёл), начисление по ставке после закрытия смены (или оклад за закрытый месяц), штрафы с причиной, сумма к выводу и кнопка «Вывести». Штрафы выписывает владелец в «Штате».',
                        'path' => '/admin/salary',
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Штат',
                        'description' => 'Список сотрудников из admins: роль, оклад/ставка, официальность, сумма к выводу. Владелец может выписать штраф с причиной — он сразу уменьшает баланс сотрудника в «Моя зарплата».',
                        'path' => '/admin/staff',
                        'audience' => 'Owner',
                    ],
                    [
