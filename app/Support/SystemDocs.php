        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Штат',
                        'description' => 'Список сотрудников и найм: кнопка «Нанять сотрудника» (ФИО, email, пароль, должность, ставка). Вкладка «На проверке» — анкеты саморегистрации. «Уволить» закрывает вход, карточку не удаляет; уволенных видно во вкладке «Уволенные», можно вернуть. Владелец может удалить запись полностью. Нельзя уволить себя и админа на открытой смене.',
                        'path' => '/admin/staff',
                        'audience' => 'Supervisor+',
                    ],
                    [
