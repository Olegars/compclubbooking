    ...
    public static function sections(): array
    {
        return [
            [
                ...
                'items' => [
                    [
                        'title' => '1.1. Электронный чек: единый UI оплаты (все каналы)',
                        'description' => "Проектирование UI/UX во всех интерфейсах продаж: Терминал, Сайт, Мобильное приложение, Шелл (лаунчер) на ПК.\n\nПеред «Оплатить» — единая логика:\n• Галочка «Отправить чек на Email/SMS» по умолчанию СНЯТА.\n• Постоянная мелкая плашка у кнопки: «Нажимая «Оплатить», вы соглашаетесь получить чек в виде QR-кода на экране».\n• Если галочка стоит — после оплаты чек дополнительно дублируется ОФД на контакт аккаунта (телефон / Email) через ClientAddress в KkmServer.\n\nСтатус: частично внедрено (сайт/ЛК/шелл пополнение + FiscalService gate). Магазин/бронь/терминал UI — добить.",
                        'path' => '/legal/offer',
                        'audience' => 'В работе · Терминал / Сайт / App / Shell',
                    ],
                    [
                        'title' => '2.2. Success Screen: фискальный QR после оплаты',
                        'description' => "После подтверждения транзакции (эквайринг / списание с баланса + ответ KkmServer) на экране устройства — итоговое окно с крупным QR по ссылке ОФД/ФНС (fiscal_receipt_url).\n\nДоступность:\n• Шелл / Приложение / ЛК сайта — QR permanently в логе транзакций профиля (кнопка/иконка «Чек» у строк с fiscal_receipt_url: пополнение, бронь, магазин). Клиент открывает в любой момент.\n• Терминал — экран с QR 20–30 с или до «Завершить»; тот же URL пишется в историю профиля.\n\nСтатус: Success QR + кнопка «Чек» в ЛК внедрены; шелл Success QR / терминал таймер — добить.",
                        'path' => '/account/dashboard',
                        'audience' => 'В работе · Терминал / Сайт / App / Shell',
                    ],
                    [
                        'title' => '3.3. Публичная оферта: акцепт и электронный чек',
                        'description' => "Юридический фундамент: расчёты без администратора через автоматы.\n\nПри регистрации профиля (или первом входе в шелл/приложение) клиент акцептует Оферту.\n\nКлючевой пункт:\n«Расчеты осуществляются с использованием автоматических устройств и электронных сервисов. Покупатель соглашается на получение кассового чека исключительно в электронном виде путем демонстрации QR-кода на экране устройства и/или сохранения QR-кода в личном кабинете. Отправка чека на SMS/Email осуществляется только при выборе соответствующей опции при оформлении платежа».\n\nСтатус: страница /legal/offer + offer_accepted_at при SMS-входе внедрены.",
                        'path' => '/legal/offer',
                        'audience' => 'В работе · Юридика / Сайт / Shell / App',
                    ],
                    [
                        'title' => '4.4. Админ: раздел «Транзакции» + печать копии чека',
                        'description' => "Отдельный раздел админки «Транзакции» (/admin/transactions):\n• список фискализуемых операций с телефоном клиента, типом, суммой, временем, статусом чека, ссылкой ОФД;\n• фильтр/поиск по телефону, типу, статусу;\n• кнопка «Напечатать» — локальная печать «КОПИЯ ЧЕКА» (QR + реквизиты) без повторного RegisterCheck.\n\nСтатус: раздел и печать копии внедрены.",
                        'path' => '/admin/transactions',
                        'audience' => 'Готово · Админ',
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => "Отдельный журнал фискализуемых операций (/admin/transactions).\n\nВ списке: телефон и имя гостя, тип (пополнение / бронь / магазин / возврат), сумма, статус чека (success / pending / error / skipped), признак «+Email/SMS» если клиент попросил отправку, ссылка ОФД.\n\nПоиск по телефону/имени, фильтр по типу и статусу.\nКнопка «Напечатать» открывает окно «КОПИЯ ЧЕКА» с QR и реквизитами первичной фискализации — без повторного RegisterCheck и без новой оплаты.\n\nСхема чеков: пополнение → аванс; бронь/магазин с баланса → полный расчёт с зачётом аванса (KkmServer, бумага выкл.).",
                        'path' => '/admin/transactions',
                        'audience' => 'Админ',
                    ],
                ],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => "Депозит и бонусный баланс. Списание за бронь и магазин, пополнение с кассы или из кабинета/шелла через ЮKassa (карта).\n\nЭлектронный чек: галочка «Отправить чек на Email/SMS» по умолчанию снята; без галочки чек только на экране (QR Success) и в логе транзакций профиля. С галочкой — ОФД дублирует на контакт аккаунта (FiscalService → ClientAddress).\nОферта: /legal/offer; при SMS-входе пишется offer_accepted_at.",
                        'path' => '/admin/transactions',
