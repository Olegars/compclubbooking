        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Штат',
                        'description' => 'Список сотрудников: должность (админ / стажёр), живой статус смены (активный / неактивный / стажёр), ставка, сумма к выводу. Вкладка «На проверке» — анкеты устройства: паспорт, скан, «Одобрить» или «Отклонить» с причиной. После одобрения стажёр получает личный кабинет. Владелец и управляющий назначают должность админ↔стажёр и могут выписать штраф.',
                        'path' => '/admin/staff',
                        'audience' => 'Supervisor+',
                    ],
                    [
