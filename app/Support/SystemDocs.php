        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Штат',
                        'description' => 'Список сотрудников и найм. Саморегистрация: вкладка «На проверке» — назначить дату визита или отклонить; после даты кнопка «Биометрия» (заглушка камеры). Кандидат затем принимает правила ПБ в кабинете. «Уволить» закрывает вход, карточку не удаляет.',
                        'path' => '/admin/staff',
                        'audience' => 'Supervisor+',
                    ],
                    [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Пункт «Документы» в конфигурации (/admin/config/documents). Системные: «Условия работы администратора» (при анкете) и «Техника пожарной безопасности» (после биометрии). Каждый документ — набор разделов (заголовок + текст). «Добавить» создаёт раздел. На сайте разделы свёрнуты; клик по заголовку раскрывает один блок, внутри — «Принимаю».',
