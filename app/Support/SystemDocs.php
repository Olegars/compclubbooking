            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Смены, начисления, штрафы, вывод. Календарь свободных слотов: «Выбрать смену» как на складе (слот, если есть место). Отмена не позднее чем за 48 часов до начала. Владелец и управляющий задают модель смен клуба: 12 часов (день/ночь) или 24 часа, и час начала (10:00, 11:00, 12:00 и т.д.) — конец считается автоматически. Уже выбранные смены сохраняются, свободные слоты другой схемы снимаются. Новая регистрация сотрудника сначала проходит устройство на работу в этом же кабинете: попап с правилами (каждое — «Принимаю»), ФИО, паспорт, скан, затем кнопка «Устроиться». Неактивный админ и стажёр видят только эту страницу. Неактивный принимает текущую смену отсюда; стажёр выходит вместе с активным админом.',
                        'path' => '/admin/salary',
