            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Смены, начисления, штрафы, вывод. Календарь свободных слотов: «Выбрать смену» как на складе (слот, если есть место). Отмена не позднее чем за 48 часов до начала. Владелец выбирает модель смен клуба: 12 часов (день 10:00–22:00 / ночь 22:00–10:00) или 24 часа (сутки с 10:00). Уже выбранные смены сохраняются, свободные слоты другой длины снимаются. Новая регистрация сотрудника сначала проходит устройство на работу в этом же кабинете: попап с правилами (каждое — «Принимаю»), ФИО, паспорт, скан, затем кнопка «Устроиться». Неактивный админ и стажёр видят только эту страницу. Неактивный принимает текущую смену отсюда; стажёр выходит вместе с активным админом.',
                        'path' => '/admin/salary',
