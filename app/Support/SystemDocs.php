            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'description' => 'Раздел «Документы» в /admin/config. Системные: «Условия работы администратора» (при анкете) и «Техника пожарной безопасности» (после биометрии). Каждый документ — набор разделов (заголовок + текст). «Добавить» создаёт раздел. На сайте разделы свёрнуты; клик по заголовку раскрывает один блок, внутри — «Принимаю».',
                        'path' => '/admin/config',
                        'audience' => 'Supervisor+',
                    ],
                    [
