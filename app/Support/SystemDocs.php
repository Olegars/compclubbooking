        ...
        return [
            [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Пересменка',
                        'description' => 'Закрытие смены: касса + факт остатков. Кто принял смену — активный админ с полным функционалом; кто сдал — неактивный и видит только «Моя зарплата». Стажёр в пересменке смену не принимает.',
                    ...
                    [
                        'title' => 'Моя зарплата',
                        'description' => 'Личный раздел: смены, начисления, штрафы, вывод. Неактивный админ и стажёр видят только эту страницу. Неактивный принимает смену отсюда; стажёр выходит в смену вместе с активным админом.',
                        'path' => '/admin/salary',
