    ...
    public static function all(): array
    {
        return [
            ...
            [
                'key' => 'arena_duels',
                'title' => 'Арена дуэлей',
                'description' => 'Дуэли и битвы без ставок: выяснить, кто лучше стреляет, разминка, быстрый матч. Лестница Elo, зал славы, царь горы за вечер. Перк (час или энергетик) — подарок клуба, не банк игроков. Судейство по GSI.',
                'group' => self::GROUP_SHELL,
                'icon' => '⚔',
                'admin_path' => null,
                'fields' => [
                    self::intField('invite_seconds', 'TTL адресного вызова, секунды', 60, 20, 180, 5, 'с'),
                    self::intField('open_ttl_minutes', 'TTL открытого вызова, минуты', 5, 1, 180, 1, 'мин'),
                    self::intField('advance_ttl_hours', 'TTL вызова из ЛК, часы', 24, 1, 48, 1, 'ч', 'Если время не указано. С расписанием лобби живёт до старта + TTL.'),
                    ...
                    self::intField('koth_min_streak', 'Царь горы: серия до перка', 3, 1, 10, 1, '', 'Первый, кто наберёт серию за вечер, получает час или напиток за счёт клуба. Один перк на вечер.'),
                    self::intField('koth_minutes', 'Царь горы: бесплатные минуты', 60, 15, 180, 15, 'мин'),
                    self::boolField('koth_prefer_drink', 'Царь горы: сначала энергетик', true, 'Если напитка нет или игрок не за ПК — продлеваем сессию на бесплатные минуты.'),
