    ...
    public static function all(): array
    {
        return [
            ...
            [
                'key' => 'arena_duels',
                'title' => 'Арена дуэлей',
                'description' => 'Открытый мини-конкурс мастерства (ГК РФ ст. 1057): дуэль 1v1 или битва на нескольких. Вызов из шелла или заранее из ЛК. Взнос с депозита в эскроу, приз обратно на депозит клуба без вывода на карту. Судейство по GSI. Не пари и не касса.',
                'group' => self::GROUP_SHELL,
                'icon' => '⚔',
                'admin_path' => null,
                'fields' => [
