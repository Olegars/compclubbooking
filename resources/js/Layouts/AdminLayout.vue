            ...
            <div class="flex-1 overflow-y-auto py-8 px-6 space-y-8 custom-scrollbar">
                ...
                <div v-if="canAccessClub" class="space-y-2">
                    ...
                    <Link v-if="isSupervisorPlus" href="/admin/suppliers"
                          class="flex items-center gap-4 px-5 py-4 rounded-2xl border transition-all text-xs font-black uppercase tracking-wider"
                          :class="isActive('/admin/suppliers') ? 'bg-[#22c55e]/10 border-[#22c55e]/30 text-[#22c55e]' : 'bg-transparent border-transparent text-white/40 hover:text-white hover:bg-white/[0.02]'">
                ...
                <div v-if="canAccessClub && isSupervisorPlus" class="space-y-2">
                    ...
                    <Link href="/admin/booking-settings"
                          class="flex items-center gap-4 px-5 py-4 rounded-2xl border transition-all text-xs font-black uppercase tracking-wider"
                          :class="isActive('/admin/booking-settings') ? 'bg-cyan-500/10 border-cyan-500/30 text-cyan-500' : 'bg-transparent border-transparent text-white/40 hover:text-white hover:bg-white/[0.02]'">
                ...
                <div v-if="canAccessClub && isSupervisorPlus" class="space-y-2">
                    ...
                    <Link href="/admin/ai-assistant"
                          class="flex items-center gap-4 px-5 py-4 rounded-2xl border transition-all text-xs font-black uppercase tracking-wider"
                          :class="isActive('/admin/ai-assistant') ? 'bg-cyan-500/10 border-cyan-500/30 text-cyan-500' : 'bg-transparent border-transparent text-white/40 hover:text-white hover:bg-white/[0.02]'">
