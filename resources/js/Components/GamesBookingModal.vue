...
<template>
    <Transition name="modal">
        <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center p-4" style="z-index: 9999999 !important;">
            ...
            <div class="relative w-full max-w-[520px] max-h-[min(82vh,720px)] bg-[#0a0a0a] border border-white/10 rounded-[32px] shadow-[0_0_80px_rgba(0,0,0,1)] overflow-hidden z-[10000000] flex flex-col">
